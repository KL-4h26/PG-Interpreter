...
class Parser:
    ...
    def __init__(self, code: list[str]):
        ...
        аргумент code ожидается в формате:
        [
            "a := 5",
            "show(a)",
            ...
        ...
        self.code = code
        self.translated = [
            # Данные формата ([аттрибуты], "общее определение команды")
        ]
        ...
        self.commands_regex = {  # Ожидаемые команды
            # Данные формата РЕГЕКС(литерал): функция
    ...
    # нахождении определенных структур команд в линии (по регексу)
    # ВСЕГДА принимают матч, возмножны другие аргументы
    ...
    def structure_alternative(self, match: re.Match):
        ...
        Общее определение команды: "STRUCTURE_ALTERNATIVE"
        """
        line = [grp.strip() for grp in match.groups()]
    ...
    def attrs_parse(self, s):
        """
        Парсит аттрибуты формата a, 5 + 5, b(), ...
